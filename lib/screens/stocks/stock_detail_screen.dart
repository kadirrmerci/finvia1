...
class _StockDetailScreenState extends State<StockDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final prevClose =
        _stockData?['chartPreviousClose']?.toDouble() ?? price;
                      ...
                      if (_chartData.isNotEmpty)
                        ...
                        const Center(
                          child: Padding(
                            ...
                            child: Text('Grafik verisi yüklenemedi',
                      ...
                      GridView.count(
                        ...
                        children: [
                          ...
                          _infoCard(
                              'Günlük Yüksek',
                              NumberFormat('#,##0.00').format(
                                  _stockData?['regularMarketDayHigh'] ??
                                      0)),
                          _infoCard(
                              'Günlük Düşük',
                              NumberFormat('#,##0.00').format(
                                  _stockData?['regularMarketDayLow'] ??
                                      0)),
                          _infoCard(
                              '52H Yüksek',
                              NumberFormat('#,##0.00').format(
                                  _stockData?['fiftyTwoWeekHigh'] ??
                                      0)),
                          _infoCard(
                              '52H Düşük',
                              NumberFormat('#,##0.00').format(
                                  _stockData?['fiftyTwoWeekLow'] ??
                                      0)),
                          _infoCard(
                              'Hacim',
                              NumberFormat('#,##0').format(
                                  _stockData?['regularMarketVolume'] ??
                                      0)),
                          _infoCard(
                              'Para Birimi',
                              _stockData?['currency'] ?? '-'),
