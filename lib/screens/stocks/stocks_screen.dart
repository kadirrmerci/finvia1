...
class _StocksScreenState extends State<StocksScreen>
  ...
  final Map<String, double?> _watchlist = {};
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        Text(
                          NumberFormat('#,##0.00').format(_totalInvested),
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                          ),
                    ...
                    Column(
                      children: [
                        ...
                        Text(
                          '${_totalProfitLoss >= 0 ? '+' : ''}${NumberFormat('#,##0.00').format(_totalProfitLoss)}',
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.bold,
                          ),
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${isProfit ? '+' : ''}${h.profitLossPercent.toStringAsFixed(2)}%',
                                        style: TextStyle(
                                          color: isProfit
                                              ? Colors.green
                                              : Colors.red,
                              ...
                              Row(
                                ...
                                children: [
                                  _statChip(
                                    'Alış',
                                    NumberFormat('#,##0.00').format(h.buyPrice),
                                  ),
                                  _statChip(
                                    'Adet',
                                    h.quantity.toStringAsFixed(4),
                                  ),
                                  _statChip(
                                    'Kar/Zarar',
        ...
        children: [
          ...
          ..._holdings.map((h) {
            final percent = _totalInvested > 0
                ? h.totalCost / _totalInvested * 100
                : 0.0;
            final isProfit = h.profitLoss >= 0;
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        'Alış: ${DateFormat('dd MMM yyyy').format(h.buyDate)}',
                        style: const TextStyle(
                          fontSize: 11,
                          color: Colors.grey,
                        ),
        ...
        builder: (context, set) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 8),
              Text(
                'Güncel: ${NumberFormat('#,##0.00').format(currentPrice)}',
          ...
          children: [
            ...
            if (alerts.isEmpty)
              ...
              ...alerts.map(
                (a) => ListTile(
                  leading: Icon(
                    a.isAbove ? Icons.trending_up : Icons.trending_down,
                  ...
                  subtitle: Text(
                    '${a.isAbove ? 'Yükselince' : 'Düşünce'}: ${NumberFormat('#,##0.00').format(a.targetPrice)}',
                  ),
                  trailing: IconButton(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, set) {
          ...
          if (sellPriceC.text.isNotEmpty) {
            final sellPrice =
                double.tryParse(sellPriceC.text.replaceAll(',', '.')) ?? 0;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    _statChip(
                      'Maliyet',
                      NumberFormat('#,##0.00').format(h.totalCost),
                    ),
                  ],
                ),
                const SizedBox(height: 16),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Text(
                        simProfit >= 0 ? 'Tahmini Kar' : 'Tahmini Zarar',
                        style: TextStyle(
                          color: simProfit >= 0 ? Colors.green : Colors.red,
                        ),
                      ),
                      Text(
                        '${simProfit >= 0 ? '+' : ''}${NumberFormat('#,##0.00').format(simProfit)}',
                        style: TextStyle(
                          color: simProfit >= 0 ? Colors.green : Colors.red,
                          fontSize: 28,
                          fontWeight: FontWeight.bold,
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: symbolC,
                decoration: InputDecoration(
                  labelText: 'Sembol (AAPL, BTC-USD, THYAO.IS)',
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                  ),
                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    if (symbolC.text.isEmpty ||
                        buyPriceC.text.isEmpty ||
                    ...
                    final h = StockHolding(
                      ...
                      buyPrice: double.parse(
                        buyPriceC.text.replaceAll(',', '.'),
                      ),
                      quantity: double.parse(
                        quantityC.text.replaceAll(',', '.'),
                      ),
